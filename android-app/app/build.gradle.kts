plugins {
    ...
    // AGP 9.0+ has built-in Kotlin support; the separate kotlin.android plugin
    // is no longer needed (and errors if applied). Compose still needs its own
    // compiler plugin.
    id("org.jetbrains.kotlin.plugin.compose")
}

android {
    namespace = "com.roxstar.voicedraft"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.roxstar.voicedraft"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"
